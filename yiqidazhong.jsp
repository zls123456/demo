...
<html>
  ...
  <body>
   <div id="cen" style="overflow:auto;">
        	...
        	<div id="richedit" contenteditable>上空的飞机立刻解放</div>
    <table id="dg" class="easyui-datagrid" title="My Users" style="width:100%;height:100%" fit=true url="getyiqi.action"
		...
		<thead>
			<tr>
				...
				<th field="firstname" width="50" editor="{type:'validatebox',options:{required:true}}">开始名称</th>
				<th field="lastname" width="50" editor="{type:'validatebox',options:{required:true}}">结束名称</th>
